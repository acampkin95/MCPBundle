...
To verify deployment from local machine:
```bash
# Check service readiness
sshpass -p "C0nnaught" ssh root@46.250.243.123 "/opt/mcp/mcp-services.sh status"

# Check logs (once started)
sshpass -p "C0nnaught" ssh root@46.250.243.123 "tail -f /opt/mcp/logs/*.log"
```
