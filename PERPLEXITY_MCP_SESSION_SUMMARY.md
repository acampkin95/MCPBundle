...
**Technical Research Tools** (3-4 hours):
4. **doc_finder.ts** - Official docs, GitHub repos, specs
5. **tech_review.ts** - Technology comparison, pros/cons
6. **whitepaper_search.ts** - Academic papers, research

**Deliberation Agent** (2 hours):
7. **deliberation-agent.ts** - ReWOO pattern, multi-round analysis
...
export async function executeTool(
  input: z.infer<typeof toolNameSchema>,
