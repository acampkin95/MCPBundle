...
export class OnboardingService {
  ...
  private async showWelcome(): Promise<void> {
    const choice = await vscode.window.showInformationMessage(
      'Welcome to Structural Thinking Manager! Would you like a quick tour?',
      { modal: false },
      'Start Tour',
      'Quick Start Guide',
      'Skip',
  ...
  private async startInteractiveTour(): Promise<void> {
    ...
    const continueStep1 = await vscode.window.showInformationMessage(
      'Step 1/5: This is your Thinking Processes sidebar. Here you can view all your structured thinking sessions.',
      { modal: false },
      'Next',
      'Skip Tour'
    );
    ...
    const continueStep2 = await vscode.window.showInformationMessage(
      'Step 2/5: Click the + button in the sidebar to create your first thinking session, or press Cmd+Shift+N (Ctrl+Shift+N on Windows).',
      { modal: false },
      'Next',
      'Skip Tour'
    );
    ...
    const continueStep3 = await vscode.window.showInformationMessage(
      'Step 3/5: You can edit thoughts with live markdown preview by clicking the edit icon next to any thought.',
      { modal: false },
      'Next',
      'Skip Tour'
    );
    ...
    const continueStep4 = await vscode.window.showInformationMessage(
      'Step 4/5: Use the search icon or press Cmd+Shift+R (Ctrl+Shift+R) to research topics with Perplexity AI during your thinking process.',
      { modal: false },
      'Next',
      'Skip Tour'
    );
    ...
    const continueStep5 = await vscode.window.showInformationMessage(
      'Step 5/5: View your thinking analytics by clicking the graph icon or pressing Cmd+Shift+A (Ctrl+Shift+A). Track your productivity and quality scores!',
      { modal: false },
      'Finish Tour',
      'Show Analytics Now'
    );
  ...
  private endTour(): void {
    ...
    void vscode.window.showInformationMessage(
      'Tour complete! You can access help anytime from the Command Palette (Cmd+Shift+P / Ctrl+Shift+P).'
    );
   ...
   */
  private getQuickStartHTML(): string {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  private getOnboardingState(): OnboardingState {
    ...
    const currentStep = this.context.globalState.get<number>(
   ...
   */
  private setOnboardingState(state: OnboardingState): void {
