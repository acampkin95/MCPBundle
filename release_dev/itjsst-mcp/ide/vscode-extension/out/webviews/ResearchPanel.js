...
class ResearchPanel {
    ...
    sessionId;
    isResearching = false;
    static createOrShow(extensionUri, researchService, logger, sessionId) {
        ...
        const panel = vscode.window.createWebviewPanel('perplexityResearch', 'Perplexity Deep Research', column ?? vscode.ViewColumn.One, {
            enableScripts: true,
            retainContextWhenHidden: true,
            localResourceRoots: [extensionUri],
        });
        ResearchPanel.currentPanel = new ResearchPanel(panel, researchService, logger, sessionId);
    }
    constructor(panel, researchService, logger, sessionId) {
        this.panel = panel;
     ...
     */
    async performResearch(query, mode) {
...
//# sourceMappingURL=ResearchPanel.js.map