...
const entries: ToolMetadataEntry[] = [
  {
    ...
    description: "Collects macOS admin membership, SecureToken holders, FileVault status, and TCC counts.",
  ...
  {
    id: "mac-diagnostics",
    description: "Runs hardware, performance, security, network, or storage diagnostics locally or over SSH.",
    requiredCapabilities: ["local-shell"],
