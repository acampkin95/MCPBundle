...
const createServer = () => {
  ...
  try {
    ...
    logger.warn(
      'PostgresManagerService initialization failed - PostgreSQL operations will be unavailable',
      { error }
    );
  }
  ...
  try {
    ...
    logger.warn(
      'RedisManagerService initialization failed - Redis operations will be unavailable',
      { error }
    );
  }
  ...
  try {
    ...
    logger.warn(
      'KeycloakManagerService initialization failed - Keycloak operations will be unavailable',
      { error }
    );
  }
