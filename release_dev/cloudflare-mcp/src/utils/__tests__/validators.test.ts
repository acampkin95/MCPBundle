...
describe('validators', () => {
  ...
  describe('validateFilePath', () => {
    it('should accept paths in allowed directories', () => {
      assert.strictEqual(validateFilePath('/var/log/nginx/access.log', ALLOWED_LOG_DIRS), true);
      assert.strictEqual(
    ...
    it('should reject path traversal attempts', () => {
      assert.strictEqual(validateFilePath('/var/log/../etc/passwd', ALLOWED_LOG_DIRS), false);
      assert.strictEqual(
    ...
    it('should reject paths outside allowed directories', () => {
      assert.strictEqual(validateFilePath('/etc/passwd', ALLOWED_LOG_DIRS), false);
      assert.strictEqual(validateFilePath('/tmp/malicious.log', ALLOWED_LOG_DIRS), false);
    });
