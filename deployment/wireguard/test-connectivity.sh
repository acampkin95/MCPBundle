...
test_tunnel() {
    ...
    result=$(sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$source_ip \
...
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$VMI01 "wg show"

echo -e "\n${BLUE}VMI02D WireGuard Status:${NC}"
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$VMI02D "wg show"

echo -e "\n${BLUE}VMI03 WireGuard Status:${NC}"
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$VMI03 "wg show"
...
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$VMI01 "ufw status numbered | head -20"

echo -e "\n${BLUE}VMI02D Firewall Status:${NC}"
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$VMI02D "ufw status numbered | head -20"

echo -e "\n${BLUE}VMI03 Firewall Status:${NC}"
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$VMI03 "ufw status numbered | head -20"

# Check fail2ban status
echo -e "\n${YELLOW}Checking fail2ban status...${NC}"

echo -e "\n${BLUE}VMI01 fail2ban Status:${NC}"
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$VMI01 "fail2ban-client status"

echo -e "\n${BLUE}VMI02D fail2ban Status:${NC}"
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$VMI02D "fail2ban-client status"

echo -e "\n${BLUE}VMI03 fail2ban Status:${NC}"
sshpass -p "$PASSWORD" ssh -o StrictHostKeyChecking=accept-new root@$VMI03 "fail2ban-client status"
