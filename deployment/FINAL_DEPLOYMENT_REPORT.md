...
Connection String:
  postgresql://mcp_admin:MCP%23Secure2025%21Prod@localhost:5432/mcp_ecosystem
```
...
SSH Command Examples:
  VMI01: sshpass -p "C0nnaught" ssh root@46.250.243.123
  VMI02D: sshpass -p "C0nnaught" ssh root@46.250.241.70
  VMI03: sshpass -p "C0nnaught" ssh root@154.26.158.31
```
...
1. **MCP Services Startup Failure**
   ...
   - **Resolution:** Added individual POSTGRES_* variables to .env files and configured systemd EnvironmentFile directive
