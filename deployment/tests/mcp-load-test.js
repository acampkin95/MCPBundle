...
export function handleSummary(data) {
    const summary = {
        ...
        metrics: {
            ...
            thoughts_created: data.metrics.thoughts_created ? data.metrics.thoughts_created.values.count : 0,
    ...
    console.log(`  Request Failure Rate: ${(summary.metrics.http_req_failed_rate * 100).toFixed(2)}%`);
